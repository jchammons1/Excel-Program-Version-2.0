VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserForm_EstimateDate 
   Caption         =   "ESTIMATE DATE SELECTION"
   ClientHeight    =   4545
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   7425
   OleObjectBlob   =   "UserForm_EstimateDate.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "UserForm_EstimateDate"
...
'The project data for the BIDTAB Estimate will be saved to the third row (row 4) always
    With Me
        ...
        Range("N3").Value = Me.TextBox1.Value
            Selection.NumberFormat = "[$-en-US]m/d/yyyy"
        Range("N4").Value = Me.TextBox1.Value
            Selection.NumberFormat = "[$-en-US]m/d/yyyy"
        Range("N5").Value = Me.TextBox1.Value
            Selection.NumberFormat = "[$-en-US]m/d/yyyy"
    End With
...
Private Sub UserForm_Initialize()
    buildCalendar
    With Me
        TextBox1.Value = PROJECT_DATA.Range("N2").Value
    End With
End Sub
